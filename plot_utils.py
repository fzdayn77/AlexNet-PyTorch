...
def plot_confusion_matrix(conf_mat, hide_spines=False, hide_ticks=False, figsize=None, cmap=None,
                          colorbar=False, show_absolute=True, show_normed=False, class_names=None):
    """
    Helps plotting a given confusion matrix.

    Parameters:
        conf_mat: the confusion matrix to be plotted
        figsize: size of the plotted figure
        class_names: names of the predefined classes in the dataset
    """
